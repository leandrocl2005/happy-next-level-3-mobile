...
export default function OrphanageData() {
  ...
  const [open_in_hours, setOpenInHours] = useState('');
  ...
  async function handleCreateOrphanage() {
    ...
    data.append('open_in_hours', open_in_hours);
  ...
  async function handleSelectedImages() {
    ...
    if (status !== 'granted') {
      alert('Eita, precisamos de acessos às suas fotos...');
      return;
    }
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <TextInput
        style={styles.input}
        value={open_in_hours}
        onChangeText={text => setOpenInHours(text)}
      />
      ...
      <View style={styles.switchContainer}>
        ...
        <Switch 
          ...
          value={open_in_weekends}
          onValueChange={setOpenInWeekends}
        />
      </View>
